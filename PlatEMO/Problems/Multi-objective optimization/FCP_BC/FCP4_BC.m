classdef FCP4_BC < PROBLEM
% <2022> <multi> <real> <constrained>
% Benchmark constrained MOP proposed by Jiawei Yuan (Binary Constraint version)
%
% CalCon returns one binary feasibility value per solution:
% 0 denotes feasible and 1 denotes infeasible.
