classdef DOC2_BC < PROBLEM
% <2019> <multi> <real> <constrained>
% Benchmark MOP with constraints in both decision and objective spaces
% Binary constraint version: all original constraints are evaluated first,
% then returned as one label (0 = feasible, 1 = infeasible).
