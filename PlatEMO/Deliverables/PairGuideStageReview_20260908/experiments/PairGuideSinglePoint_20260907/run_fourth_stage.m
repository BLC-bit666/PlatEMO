...
base=struct('initialEpoch',1000,'retrainEpoch',20,'nCritic',5,'lrG',1e-3,'lrD',1e-3,'mismatchFraction',.5);
configs={base,base,base}; configs{2}.initialEpoch=2000;
configs{3}.initialEpoch=2000; configs{3}.trainingSigma=0; configs{3}.sampleSigma=0;
names=["mis1000","mis2000","miszero2000"];
...
save(fullfile(folder,'stage4_status.mat'),'Tasks','errors'); delete(pool);
assert(all(strlength(errors)==0)); disp('STAGE4_COMPLETE');
