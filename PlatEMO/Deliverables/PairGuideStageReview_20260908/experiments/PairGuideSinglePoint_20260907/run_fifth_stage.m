...
base=struct('initialEpoch',1000,'retrainEpoch',20,'nCritic',5,'lrG',1e-3,'lrD',1e-3, ...
    'trainingSigma',0,'sampleSigma',0);
configs={base,base,base,base}; configs{2}.initialEpoch=4000;
configs{3}.mismatchFraction=.5;
configs{4}.initialEpoch=4000; configs{4}.mismatchFraction=.5;
names=["lrzero1000","lrzero4000","miszero1000","miszero4000"];
...
save(fullfile(folder,'stage5_status.mat'),'Tasks','errors'); delete(pool);
assert(all(strlength(errors)==0)); disp('STAGE5_COMPLETE');
