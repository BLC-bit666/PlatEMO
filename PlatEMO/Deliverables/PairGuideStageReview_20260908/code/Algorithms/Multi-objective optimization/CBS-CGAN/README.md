...
本轮已完成 121 个首次使用实验、36 次完整搜索和 8 个方向留出/续训检查，详见[实现与实验报告](</Users/lanai/Code/Matlab/PlatEMO/PlatEMO/Data/PairGuideSinglePoint_20260907/RESULTS.md>)。首训选为 1000 次更新；完整实验尚未显示稳定优于对照，方向与 0/1 标签控制仍不可靠，不能将本轮修改描述为已经解决生成偏移。
