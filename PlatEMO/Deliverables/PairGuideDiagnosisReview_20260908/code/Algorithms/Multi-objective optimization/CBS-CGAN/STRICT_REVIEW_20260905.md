...
位置：[PairBoundaryArchive_RC.m:168](Core/PairBoundaryArchive_RC.m%3A168)。回归同时覆盖普通点的五方向限制和原 pair 归属豁免。
...
位置：[PairGuideCore.m:856](Core/PairGuideCore.m%3A856)。分析脚本的查询率、服务率和正使用率分母同步排除没有相应名额的尾批。
...
位置：[PairGuideCore.m:661](Core/PairGuideCore.m%3A661)。
...
位置：[PairBoundaryArchive_RC.m:436](Core/PairBoundaryArchive_RC.m%3A436)、[analyze_PairGuide_interval_validation.m](Support/analyze_PairGuide_interval_validation.m)。
...
共享对话正文：[shared-dialogue.md](../../../tmp/smart-search-evidence/pairguide-strict-audit-20260905/shared-dialogue.md)。复现与测试摘录：[verification.txt](../../../tmp/smart-search-evidence/pairguide-strict-audit-20260905/verification.txt)。三组短运行汇总：[interval_summary.csv](/tmp/pairguide-review-controls-20260905/interval_summary.csv)。本次没有提交、推送或修改旧算法身份。
