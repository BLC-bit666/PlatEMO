...
function [hFeasible,hInfeasible] = draw2D( ...
    ...
    dynamicProblems = ["LIRCMOP5_BC","LIRCMOP6_BC","LIRCMOP7_BC", ...
        "LIRCMOP8_BC","LIRCMOP9_BC","LIRCMOP10_BC","LIRCMOP12_BC"];
    ...
    switch problemName
        case "LIRCMOP5_BC"
            violation = ellipseViolation(Obj,[1.6,2.5], ...
                [1.6,2.5],[2,2],[4,8]);
        case "LIRCMOP6_BC"
            violation = ellipseViolation(Obj,[1.8,2.8], ...
                [1.8,2.8],[2,2],[8,8]);
        case {"LIRCMOP7_BC","LIRCMOP8_BC"}
            violation = ellipseViolation(Obj,[1.2,2.25,3.5], ...
                [1.2,2.25,3.5],[2,2.5,2.5],[6,12,10]);
        case {"LIRCMOP9_BC","LIRCMOP10_BC","LIRCMOP12_BC"}
            theta = -0.25*pi;
            if problemName == "LIRCMOP9_BC"
                p = 1.4; q = 1.4; a = 1.5; b = 6; offset = 2;
            elseif problemName == "LIRCMOP10_BC"
                p = 1.1;
                q = 1.2;
                a = 2;
                b = 4;
