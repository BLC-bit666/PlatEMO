...
%   Additional oracle calls are cached and billed separately after search.
    ...
    if isfile(cacheFile)
        ...
        if isfield(old.Report,'rendererVersion') && old.Report.rendererVersion==6 && ...
    ...
    Report=struct('rendererVersion',6,'sourceHash',R.Record.sourceHash,'problem',R.Record.problem, ...
