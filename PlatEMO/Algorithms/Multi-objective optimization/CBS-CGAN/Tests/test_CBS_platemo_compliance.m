...
%TEST_CBS_PLATEMO_COMPLIANCE Verify the public PlatEMO algorithm contract.
    ...
    entryNames = string(cellfun(@func2str,EntryAlgorithms, ...
        'UniformOutput',false));
    required = ["CBS_RegionWGAN_GP","CBS_RegionWGAN_GP_A1", ...
        "CBS_RegionWGAN_GP_A2","CBS_RegionWGAN_GP_Random20", ...
        "CBS_RegionWGAN_GP_DE20","CBS_RegionWGAN_GP_GA20"];
    assert(all(ismember(required,entryNames)));
    assert(~any(ismember(["CBS_RegionWGAN_GP_Core", ...
        "CBS_RegionWGAN_GP_Experiment"],entryNames)));
