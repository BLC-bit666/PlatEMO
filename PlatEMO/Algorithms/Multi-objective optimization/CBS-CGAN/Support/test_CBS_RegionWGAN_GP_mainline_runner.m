...
%TEST_CBS_REGIONWGAN_GP_MAINLINE_RUNNER Verify IGD-only output and resume.
    ...
    Config = jsondecode(fileread(fullfile(outDir,'mainline_config.json')));
    assert(Config.maxFE == 600 && Config.ganStopFraction == 0.5 && ...
        Config.ganStopFE == 300 && ...
        string(Config.schemaVersion) == ...
            "cbs_region_wgan_igd_mainline_v2");
