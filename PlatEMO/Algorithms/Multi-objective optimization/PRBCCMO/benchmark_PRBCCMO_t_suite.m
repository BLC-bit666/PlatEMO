...
% Run traced PRBCCMO_t benchmarks and emit a run-level CSV summary.
    ...
    Rows = cell(numel(problemNames)*numel(runIds),32);
    row = 0;
    for p = 1 : numel(problemNames)
        ...
        for r = runIds
            ...
            Rows(row,:) = { ...
                ...
                Trace.final_b_size,Trace.final_b_lowmargin_ratio, ...
                Trace.final_b_mean_dist_to_true_boundary,Trace.final_b_p90_dist_to_true_boundary, ...
                Trace.final_boundary_off_hit_rate_eps,Trace.final_archive_hit_rate_eps, ...
                Trace.final_boundary_off_count,Trace.final_boundary_evidence_count, ...
                Trace.final_boundary_evidence_feasible_ratio,Trace.final_boundary_lowmargin_pair_hit, ...
                ...
                Trace.final_b_margin_true_boundary_corr,Trace.final_b_margin_oppdist_corr,Trace.final_b_lowmargin_oppdist_gain, ...
                Trace.final_train_boundary_evidence_count, ...
    ...
    Results = cell2table(Rows(1:row,:), ...
        ...
        'final_boundary_survive_u_rate','final_b_margin_true_boundary_corr','final_b_margin_oppdist_corr', ...
        'final_b_lowmargin_oppdist_gain','final_train_boundary_evidence_count','final_inf_lowmargin_ratio_gain', ...
