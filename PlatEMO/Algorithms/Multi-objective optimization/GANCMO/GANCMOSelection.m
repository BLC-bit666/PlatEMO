function [Population,Fitness] = ...
        GANCMOSelection(Population,N,isConstrained)
%GANCMOSELECTION CCMO/SPEA2 survival for both populations.
...
%--------------------------------------------------------------------------
    ...
    if isConstrained
        Fitness = GANCMOFitness(Population.objs,Population.cons);
    else
        Fitness = GANCMOFitness(Population.objs);
    end
    Next = Fitness < 1;
