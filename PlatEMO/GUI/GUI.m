...
%--------------------------------------------------------------------------
    ...
    methods
        ...
        function obj = GUI()
            ...
            % Create the window
            obj.app.figure   = uifigure('Name','PlatEMO v4.16','Position',[0 0 1200 650],'Interruptible','off','icon',obj.icon.logo1,'BusyAction','cancel','Visible',false,'WindowButtonMotionFcn',@(~,~)[]);
	...
	methods(Access = private)
        ...
        function cb_author(obj,~,~)
            ...
            uilabel(f,'Position',[10 80 150 40],'Text',{'Copyright (c) 2026','BIMK Group'},'HorizontalAlignment','left','FontSize',12);
