function [Results,RunTable,ProblemTable,FamilyTable,MetricAnalysis] = run_PRBCCMO_t_DAS_LIR_parallel(runs,workerCount,N,maxFE,outDir)
% Run PRBCCMO_t on all DASCMOP_BC and LIRCMOP_BC problems with CSV outputs only.
    ...
    MetricAnalysis = analyze_PRBCCMO_t_benchmark_metrics(Results,outDir);
    summarize_PRBCCMO_t_probability_histograms(RunTable,outDir);
end
