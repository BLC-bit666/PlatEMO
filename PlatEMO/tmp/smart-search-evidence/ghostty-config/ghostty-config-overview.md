![Ghostty](/_next/static/media/ghostty-wordmark.815bf882.svg)
...
*necessary configuration* to use Ghostty.
...
In the source code, you can find the configuration structure in the
...
Not documentation per se, but you can search for the
